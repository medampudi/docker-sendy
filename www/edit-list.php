...
<script src="<?php echo get_app_info('path');?>/js/lists/editor.js?8"></script>
		        ...
		        <div class="well">
			    	...
			    	<div class="control-group">
				    	<div class="controls">
			              ...
			              <a href="javascript:void(0)" style="font-size: 12px;" id="advanced-options-btn-1"><span class="icon icon-plus-sign"></span> Advanced options</a>
			            </div>
			        </div>
		        ...
		        <div class="well">
			    	...
			    	<div class="control-group">
				    	<div class="controls">
			              ...
			              <a href="javascript:void(0)" style="font-size: 12px;" id="advanced-options-btn-2"><span class="icon icon-plus-sign"></span> Advanced options</a>
			            </div>
			        </div>
		        ...
		        <div class="well">
			    	...
			    	<div class="control-group">
				    	<div class="controls">
			              ...
			              <a href="javascript:void(0)" style="font-size: 12px;" id="advanced-options-btn-3"><span class="icon icon-plus-sign"></span> Advanced options</a>
			            </div>
			        </div>
